...
class VWAPStochTrendStrategy(BaseStrategy):
    ...
    def evaluate_signals(
        ...
        df['Long_Signal'] = time_filter & df['Rel_Strength_Pass'] & df['VWAP_Long_Pass'] & df['ADX_Pass'] & df['Stoch_Long_Pass']
        df['Short_Signal'] = time_filter & df['Rel_Weakness_Pass'] & df['VWAP_Short_Pass'] & df['ADX_Pass'] & df['Stoch_Short_Pass']
...
STRATEGY_INSTANCE = VWAPStochTrendStrategy()
